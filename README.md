...
- **Executive CMS Portal (`/admin`)**: Password-protected portal (`[REDACTED_ADMIN_SECRET]`) for managing studio availability, resetting test bookings, managing event flyers, and reviewing email mailing list subscribers.
...
ADMIN_KEY=[REDACTED_ADMIN_SECRET]
PORT=8000
