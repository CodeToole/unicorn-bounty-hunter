...
r_admin_slots = request("GET", f"/admin?key=[REDACTED_ADMIN_SECRET]&tab=slots&date={test_date}")
...
r_admin_after = request("GET", f"/admin?key=[REDACTED_ADMIN_SECRET]&tab=slots&date={test_date}")
